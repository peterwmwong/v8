...
KNOWN_MAPS = {
  ...
  ("RO_SPACE", 0x09d39): (154, "AccessorInfoMap"),
  ("RO_SPACE", 0x09d89): (153, "AccessCheckInfoMap"),
  ("RO_SPACE", 0x09dd9): (155, "AccessorPairMap"),
  ("RO_SPACE", 0x09e29): (156, "AliasedArgumentsEntryMap"),
  ("RO_SPACE", 0x09e79): (157, "AllocationMementoMap"),
  ("RO_SPACE", 0x09ec9): (158, "AsyncGeneratorRequestMap"),
  ("RO_SPACE", 0x09f19): (159, "DebugInfoMap"),
  ("RO_SPACE", 0x09f69): (160, "FunctionTemplateInfoMap"),
  ("RO_SPACE", 0x09fb9): (162, "InterpreterDataMap"),
  ("RO_SPACE", 0x0a009): (163, "ModuleInfoEntryMap"),
  ("RO_SPACE", 0x0a059): (164, "ModuleMap"),
  ("RO_SPACE", 0x0a0a9): (165, "ObjectTemplateInfoMap"),
  ("RO_SPACE", 0x0a0f9): (166, "PromiseCapabilityMap"),
  ("RO_SPACE", 0x0a149): (167, "PromiseReactionMap"),
  ("RO_SPACE", 0x0a199): (168, "PrototypeInfoMap"),
  ("RO_SPACE", 0x0a1e9): (170, "StackFrameInfoMap"),
  ("RO_SPACE", 0x0a239): (172, "Tuple3Map"),
  ("RO_SPACE", 0x0a289): (174, "WasmDebugInfoMap"),
  ("RO_SPACE", 0x0a2d9): (175, "WasmExportedFunctionDataMap"),
  ("RO_SPACE", 0x0a329): (176, "CallableTaskMap"),
  ("RO_SPACE", 0x0a379): (177, "CallbackTaskMap"),
  ("RO_SPACE", 0x0a3c9): (178, "PromiseFulfillReactionJobTaskMap"),
  ("RO_SPACE", 0x0a419): (179, "PromiseRejectReactionJobTaskMap"),
  ("RO_SPACE", 0x0a469): (180, "PromiseResolveThenableJobTaskMap"),
  ("RO_SPACE", 0x0a4b9): (181, "MicrotaskQueueMap"),
  ("RO_SPACE", 0x0a509): (182, "AllocationSiteMap"),
  ("RO_SPACE", 0x0a559): (182, "AllocationSiteMap"),
