...
class WeakCollectionsBuiltinsAssembler : public CodeStubAssembler {
 ...
 protected:
  ...
  TNode<Smi> CallGetOrCreateHashRaw(TNode<Object> key);
...
TNode<Smi> WeakCollectionsBuiltinsAssembler::CallGetOrCreateHashRaw(
    TNode<Object> key) {
  Node* const function_addr =
      ExternalConstant(ExternalReference::get_or_create_hash_raw(isolate()));
  Node* const isolate_ptr =
...
TF_BUILTIN(WeakCollectionSet, WeakCollectionsBuiltinsAssembler) {
  ...
  Label done(this), call_runtime(this), if_doesnt_exist(this);
