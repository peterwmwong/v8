...
TNode<IntPtrT> LoadJSReceiverIdentityHash(
    ...
    CodeStubAssembler::Label* if_no_hash = nullptr) {
  ...
  if (if_no_hash != nullptr) {
    a->GotoIf(a->IntPtrEqual(var_hash,
                             a->IntPtrConstant(PropertyArray::kNoHashSentinel)),
              if_no_hash);
  }
  return var_hash;
}
...
TF_BUILTIN(WeakMapLookupHashIndex, WeakCollectionsBuiltinsAssembler) {
  ...
  TNode<IntPtrT> hash = LoadJSReceiverIdentityHash(this, key, &if_not_found);
...
TF_BUILTIN(WeakCollectionSet, WeakCollectionsBuiltinsAssembler) {
  ...
  TVARIABLE(IntPtrT, var_hash,
            LoadJSReceiverIdentityHash(this, key, &if_no_hash));
  TNode<IntPtrT> key_index =
