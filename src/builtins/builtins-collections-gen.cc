...
class BaseCollectionsAssembler : public CodeStubAssembler {
 ...
 protected:
  ...
  // function has been not been modified.
...
TNode<Object> BaseCollectionsAssembler::AddConstructorEntry(
  ...
  if (variant == kMap) {
    ...
    TNode<Object> add_call = UncheckedCast<Object>(
...
void BaseCollectionsAssembler::AddConstructorEntries(
  ...
  GotoIf(IsUndefined(initial_entries), &exit);
...
void BaseCollectionsAssembler::AddConstructorEntriesFromIterable(
  ...
  GotoIf(IsNullOrUndefined(iterable), &exit);
...
void BaseCollectionsAssembler::GenerateConstructor(
  ...
  StoreObjectFieldNoWriteBarrier(collection, CollectionType::kTableOffset,
                                 table);
...
TF_BUILTIN(MapConstructor, CollectionsBuiltinsAssembler) {
  GenerateConstructor<JSMap>(kMap, Context::JS_MAP_FUN_INDEX,
                             isolate()->factory()->Map_string());
}

TF_BUILTIN(SetConstructor, CollectionsBuiltinsAssembler) {
  GenerateConstructor<JSSet>(kSet, Context::JS_SET_FUN_INDEX,
                             isolate()->factory()->Set_string());
}
...
TNode<Object> WeakCollectionsBuiltinsAssembler::AllocateTable(
  ...
  // Verify a shift left by 1 is the same as multiplying by
  // ObjectHashTable::kEntrySize (2).
  STATIC_ASSERT(ObjectHashTable::kEntrySize == 2);
  TNode<IntPtrT> end =
      IntPtrAdd(start, UncheckedCast<IntPtrT>(WordShl(capacity, 1)));
  FillFixedArrayWithValue(HOLEY_ELEMENTS, table, start, end,
...
TF_BUILTIN(WeakMapConstructor, WeakCollectionsBuiltinsAssembler) {
  GenerateConstructor<JSWeakMap>(kMap, Context::JS_WEAK_MAP_FUN_INDEX,
                                 isolate()->factory()->WeakMap_string());
}

TF_BUILTIN(WeakSetConstructor, WeakCollectionsBuiltinsAssembler) {
  GenerateConstructor<JSWeakSet>(kSet, Context::JS_WEAK_SET_FUN_INDEX,
