...
TNode<Object> RegExpBuiltinsAssembler::MatchAllIterator(
  ...
  BIND(&create_iterator);
  {
    ...
    TNode<Word32T> iterator_flags =
        Word32Or(Word32Or(Int32Constant(0), global_flag), unicode_flag);
