...
KNOWN_MAPS = {
  ...
  ("RO_SPACE", 0x09ae9): (154, "AccessorInfoMap"),
  ("RO_SPACE", 0x09b39): (153, "AccessCheckInfoMap"),
  ("RO_SPACE", 0x09b89): (155, "AccessorPairMap"),
  ("RO_SPACE", 0x09bd9): (156, "AliasedArgumentsEntryMap"),
  ("RO_SPACE", 0x09c29): (157, "AllocationMementoMap"),
  ("RO_SPACE", 0x09c79): (158, "AsyncGeneratorRequestMap"),
  ("RO_SPACE", 0x09cc9): (159, "DebugInfoMap"),
  ("RO_SPACE", 0x09d19): (160, "FunctionTemplateInfoMap"),
  ("RO_SPACE", 0x09d69): (162, "InterpreterDataMap"),
  ("RO_SPACE", 0x09db9): (163, "ModuleInfoEntryMap"),
  ("RO_SPACE", 0x09e09): (164, "ModuleMap"),
  ("RO_SPACE", 0x09e59): (165, "ObjectTemplateInfoMap"),
  ("RO_SPACE", 0x09ea9): (166, "PromiseCapabilityMap"),
  ("RO_SPACE", 0x09ef9): (167, "PromiseReactionMap"),
  ("RO_SPACE", 0x09f49): (168, "PrototypeInfoMap"),
  ("RO_SPACE", 0x09f99): (170, "StackFrameInfoMap"),
  ("RO_SPACE", 0x09fe9): (172, "Tuple3Map"),
  ("RO_SPACE", 0x0a039): (174, "WasmDebugInfoMap"),
  ("RO_SPACE", 0x0a089): (175, "WasmExportedFunctionDataMap"),
  ("RO_SPACE", 0x0a0d9): (176, "CallableTaskMap"),
  ("RO_SPACE", 0x0a129): (177, "CallbackTaskMap"),
  ("RO_SPACE", 0x0a179): (178, "PromiseFulfillReactionJobTaskMap"),
  ("RO_SPACE", 0x0a1c9): (179, "PromiseRejectReactionJobTaskMap"),
  ("RO_SPACE", 0x0a219): (180, "PromiseResolveThenableJobTaskMap"),
  ("RO_SPACE", 0x0a269): (181, "AllocationSiteMap"),
  ("RO_SPACE", 0x0a2b9): (181, "AllocationSiteMap"),
