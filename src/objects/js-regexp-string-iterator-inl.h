...
ACCESSORS(JSRegExpStringIterator, regex, Object, kIteratingRegExpOffset)
ACCESSORS(JSRegExpStringIterator, string, Object, kIteratedStringOffset)

INT32_ACCESSORS(JSRegExpStringIterator, flags, kFlagsOffset)
