...
KNOWN_MAPS = {
  ...
  ("RO_SPACE", 0x09fd1): (173, "ArrayBoilerplateDescriptionMap"),
  ("RO_SPACE", 0x0a021): (174, "WasmDebugInfoMap"),
  ("RO_SPACE", 0x0a071): (175, "WasmExportedFunctionDataMap"),
  ("RO_SPACE", 0x0a0c1): (176, "CallableTaskMap"),
  ("RO_SPACE", 0x0a111): (177, "CallbackTaskMap"),
  ("RO_SPACE", 0x0a161): (178, "PromiseFulfillReactionJobTaskMap"),
  ("RO_SPACE", 0x0a1b1): (179, "PromiseRejectReactionJobTaskMap"),
  ("RO_SPACE", 0x0a201): (180, "PromiseResolveThenableJobTaskMap"),
  ("RO_SPACE", 0x0a251): (181, "AllocationSiteMap"),
  ("RO_SPACE", 0x0a2a1): (181, "AllocationSiteMap"),
